...
import { Pressable, StyleSheet, TouchableOpacity, Dimensions, TouchableHighlight } from "react-native";
...
export default function ViewProfile({ navigation }: Props) {
            ...
            {user && (
                <View style={styles.main}>
                    ...
                    <View style={styles.row}>
                        <View style={styles.item}>
                            <Text style={styles.label}>Date of Birth:</Text>
                            <Text style={styles.input}>{displayDate(user.attributes.date_of_birth)}</Text>
                        </View>
                        <View style={styles.item}>
                            <Text style={styles.label}>Gender:</Text>
                            <Text style={styles.input}>{user.attributes.gender}</Text>
