import { Pressable, StyleSheet, TouchableOpacity, RefreshControl, Image, Dimensions, ActivityIndicator } from "react-native";
...
export default function History({ navigation }: Props) {
    ...
    const styleSVG = (item) => {
        ...
        const expiryDate = new Date(item?.included?.amortizations.find((item) => item.actual_amount == 0)?.expected_payment_date);
