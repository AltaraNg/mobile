...
const RenderPagination = ({ activeIndex, slider, data, onIntroCompleted, loginPassword }: RenderPaginationProps) => {
                ...
                <View style={styles.paginationDots}>
                    {data.length > 1 &&
                        data.map((_, i) => (
                            <Pressable
                                key={i}
                                style={[styles.dot, i === activeIndex ? { backgroundColor: "#EFF5F9" } : { backgroundColor: "#074A74" }]}
