        ...
        <View style={styles.container}>
            ...
            <View style={styles.messageDetail}>
                <View style={styles.title}>
                    <Text style={{ color: "#7B7A7A", fontFamily: "Montserrat_400Regular", fontSize: 13 }}>
                        From:{" "}
                        <Text style={{ color: "#000", fontWeight: "600", fontFamily: "Montserrat_600SemiBold", fontSize: 13 }}>
                            {JSON.parse(notification.data).sender.name}
                        </Text>
                    </Text>
                    <Text style={{ color: "#7B7A7A", fontFamily: "Montserrat_400Regular", fontSize: 13 }}>{notification.created_at}</Text>
                </View>
                <View style={styles.detail}>
                    <Text style={{ color: "#074A74", fontFamily: "Montserrat_700Bold", fontSize: 18, lineHeight: 22 }}>
                        {JSON.parse(notification.data).subject}
                    </Text>
                    <Text style={{ color: "#18191F", fontFamily: "Montserrat_700Bold", fontSize: 13, lineHeight: 16, marginTop: 20 }}>
