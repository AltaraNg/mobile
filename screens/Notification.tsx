import { Pressable, StyleSheet, TouchableOpacity, FlatList, Image, Dimensions, RefreshControl } from "react-native";
...
export default function Notification({ navigation }: Props) {
    ...
    const { fetchNotification } = useAuth();
                    ...
                    >
                        {notifications?.length > 0 ? (
                            <FlatList
                                ...
                                refreshControl={<RefreshControl refreshing={refreshing} onRefresh={fetchNotificationNorm} />}
                                renderItem={({ item }) => (
                                    <Pressable onPress={() => viewDetail(item)}>
                                        <View style={item.read_at ? styles.order : styles.orderRead}>
                                            ...
                                            <Text style={{ color: "#777", fontSize: 12 }}>{item.created_at}</Text>
                            ...
                            >
                                <Image source={require("../assets/images/zeroNotifications.png")} style={styles.image} />
